  ...
  return (
    <div style={{
      ...
      {suggestions.map(s => {
        ...
        const changeColor = e ? (e.changePercent >= 0 ? "var(--pos)" : "var(--neg)") : "var(--text-secondary)";
        return (
          <div
            key={s.ticker}
            onClick={() => onSelect(s)}
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--accent)", flexShrink: 0, marginLeft: 8 }}>{s.ticker}</span>
            </div>
            ...
            {e ? (
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 5, flexWrap: "wrap" }}>
                ...
                <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 500, color: changeColor }}>
                ...
                {e.peForward > 0 && (
                  <span style={{ fontSize: 10, padding: "1px 6px", borderRadius: 3, background: "var(--border-light)", color: "var(--text-secondary)", fontFamily: "var(--font-mono)" }}>P/E {e.peForward}x</span>
                )}
                {e.marketCap > 0 && (
                  <span style={{ fontSize: 10, padding: "1px 6px", borderRadius: 3, background: "var(--border-light)", color: "var(--text-secondary)", fontFamily: "var(--font-mono)" }}>MCap {e.marketCap}B</span>
                )}
              </div>
            ) : (
              enrichRef.current > 0 && (
