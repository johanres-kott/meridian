      ...
      {q.allowCustom && (
        <div style={{ display: "flex", gap: 6, marginTop: 6 }}>
          <input
            ...
            style={{ flex: 1, padding: "6px 10px", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", fontSize: 12, background: "var(--bg-card)", color: "var(--text)", fontFamily: "inherit", outline: "none" }}
          />
          {customValue && (
