...
export default async function handler(req, res) {
  ...
  let systemPrompt = `Du är en finansassistent i appen Meridian. Svara på svenska, kort och koncist. Du har tillgång till användarens portfölj och marknadsdata.`;
