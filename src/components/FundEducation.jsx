...
function FeeCalculator() {
  ...
  return (
    <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", padding: 16, marginTop: 12 }}>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 16 }}>
        <div>
          ...
          <select value={amount} onChange={e => setAmount(Number(e.target.value))}
            style={{ padding: "5px 8px", fontSize: 12, border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", background: "var(--bg-card)", color: "var(--text)", fontFamily: "inherit" }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 16 }}>
        {/* Passive vs Active */}
        <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", padding: 16 }}>
