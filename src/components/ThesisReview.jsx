        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
            ...
            <button
              ...
              disabled={saving}
              style={{ fontSize: 11, padding: "6px 14px", border: "1px solid var(--card-border)", borderRadius: "var(--radius-lg)", background: "var(--bg-card)", cursor: "pointer", fontFamily: "inherit" }}
            >
              Avbryt
            </button>
          </div>
