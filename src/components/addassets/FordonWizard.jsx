  ...
  return (
    <div style={{ display: "flex", gap: isMobile ? 0 : 32, flexDirection: isMobile ? "column" : "row" }}>
      ...
      <div style={{ flex: 1, maxWidth: 640 }}>
        ...
        {step === 1 && isLeasing && (
          <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
            <div style={{ fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.6, padding: "12px 14px", background: "var(--bg-card)", border: "1px solid var(--card-border)", borderRadius: "var(--radius-lg)" }}>
        ...
        {step === 2 && d.financing === "kontant" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
            ...
            {value != null && (
              <div style={{ maxWidth: 260, background: "var(--bg-card)", border: "1px solid var(--card-border)", borderRadius: "var(--radius-lg)", padding: "12px 16px" }}>
