  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
        ...
        <span style={{ fontFamily: "var(--font-display)", fontSize: 24, fontWeight: 700, letterSpacing: "-0.5px", color: "#131722" }}>Thesion</span>
      </div>
      ...
      <div style={{
        ...
        {error && (
          <div style={{ padding: "12px 14px", background: "#fff5f5", border: "1px solid #ffd0d0", borderRadius: 4, fontSize: 13, color: "var(--neg)", marginBottom: 16 }}>
            {error}
          </div>
        )}
        ...
        <form onSubmit={mode === "signup" ? handleSignup : mode === "magic" ? handleMagicLink : handleLogin}>
          ...
          <button
            ...
            style={{ width: "100%", padding: "11px", background: "var(--brand)", color: "#fff", border: "none", borderRadius: 4, fontSize: 13, fontWeight: 500, cursor: loading ? "not-allowed" : "pointer", fontFamily: "inherit", opacity: loading ? 0.7 : 1 }}
          >
        ...
        <div style={{ marginTop: 20, textAlign: "center", borderTop: "1px solid #f0f3fa", paddingTop: 20 }}>
          ...
          {mode === "signup" && (
            <div style={{ fontSize: 12, color: "#787b86" }}>
              ...
              <button
                onClick={() => { setMode("login"); setError(null); setMessage(null); }}
                style={{ color: "var(--brand)", background: "none", border: "none", cursor: "pointer", fontFamily: "inherit", fontSize: 12 }}
              >
                Logga in
              </button>
            </div>
